...
// PlayerSearchResult is returned by the player search endpoint.
...
// Level represents a single level created by a player.
type Level struct {
...
// PlayerProfile is the full profile returned by the profile endpoint.
